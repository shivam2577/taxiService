...
<div class="container-fluid">
  ...
  <div class="top-right" style="padding-right:100px;padding-top:50px">
    <div class="row">
      <div class="col">
        <div class="jumbotron" style="width:350px ;background-color:#F2F2F2;height:360px; padding:25px">
          <button type="button" onclick="location.href='userSignin.php'" class="btn btn-dark" style="width:100%;height:50px;font-size: 12px;background-color:black">ALREADY HAVE AN ACCOUNT?</button>
          <form method="post" action="form_userSignUp.php">
            ...
            <input required type="text" class="form-control"placeholder="Email" name="email" style="margin-top:10px" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Invalid Email Id">
            ...
            <button type="submit" id="btn"class="btn btn-info" style="width:100%;height:40px;font-size: 14px;margin-top:40px"><b>SUBMIT</b></button>
          </form>
        </div>
      </div>
    </div>
